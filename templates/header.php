<header class="banner" id="banner">
    ...
    <nav class="banner__nav">
        ...
        <div class="banner__footer banner__footer--grow banner__footer--shrink">
            <a class="banner__download" href="<?php acf_set_language_to_default(); the_field('catalogo', 'options'); acf_unset_language_to_default(); ?>" target="_blank"><strong><?php _e('Scarica il catalogo', 'polaris'); ?></strong><i class="icon-arrow-big"></i></a>
