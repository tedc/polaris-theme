<aside class="aside aside--left"<?php scrollmagic('"class":"aside--sticky","triggerElement":".footer","triggerHook":1,"duration":0'); ?>>
    <span class="scroll scroll--upper scroll--down" <?php scrollmagic('"tween":{"autoAlpha":false},"triggerHook":0,"duration":0,"triggerElement":".footer","offset":-20'); ?>><i class="icon-arrow"></i><?php _e('Scroll', 'polaris'); ?></span>
