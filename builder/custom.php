...
<div class="custom custom--grow-lg custom--shrink">
	...
	<div class="custom__carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1,,"variableWidth":true, "centerMode" : true,"infinite":true,"speed" : 1000, "cssEase" : "linear","prevArrow":"#<?php echo sanitize_title(get_sub_field('item_title')); ?>_<?php echo $item; ?> .custom__arrow--prev","nextArrow":"#<?php echo sanitize_title(get_sub_field('item_title')); ?>_<?php echo $item; ?>  .custom__arrow--next", "responsive":[{"breakpoint" : 640,"settings" :{"slidesToShow": 1,"variableWidth":false}}]}'>
