<div class="slider" data-slick='{"fade":true,"speed":1000, "dots":false,"infinite":true,"prevArrow":"#slider_<?php echo $row; ?> .arrows__prev","nextArrow":"#slider_<?php echo $row; ?> .arrows__next"}'>
	...
	<div class="slider__item" style="background-image:url(<?php echo $image['url']; ?>)"<?php scrollmagic('"tween":{"backgroundPosition" : "50% 10%"}, "duration" : "200vh", "triggerHook" : "onEnter", "triggerElement" : "#slider_'.$row.'"'); ?>>
