<div class="section section--grid section--grow-lg section<?php the_sub_field('background_color'); ?>"<?php scrollmagic('"class":"section--active","triggerHook":0.35,"duration":0'); ?>>
