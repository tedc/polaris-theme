<?php 
 ...
 $mv = ($col%2==0) ? '"80"' : '"-80"'; ?>
<div class="section__content <?php echo ($is_anim) ? 'section__content--anim ' : ''; ?>section__content--grow-lg section__content--shrink section__content--shrink<?php echo ($col%2==0) ? '-right-double' : '-left-double'; ?>"<?php scrollmagic('"tween":{"y":'. $mv . '},"triggerElement":"#col_'.$col.'_'.$row.'", "triggerHook":1,"duration":"150vh"'); ?>>
