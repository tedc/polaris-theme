...
?>
<div class="section__content<?php echo (get_sub_field('move_text')) ? ' section__content--move' : ''; ?> section__content--anim section__content--grow-lg section__content--shrink"<?php $mv = ($col%2==0) ? '"80"' : '"-80"'; ?>>
